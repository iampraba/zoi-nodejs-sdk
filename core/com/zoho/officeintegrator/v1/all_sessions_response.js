...
class AllSessionsResponse{
	 ...
	 * @returns {Array} An Array representing the sessions
	 */
	getSessions()	{
	 ...
	 * @param {Array} sessions An Array representing the sessions
	 */
	setSessions(sessions)	{
		if((sessions != null) && (!(Object.prototype.toString.call(sessions) == "[object Array]")))	{
			throw new SDKException(Constants.DATA_TYPE_ERROR, "KEY: sessions EXPECTED TYPE: Array", null, null);
		}
		this.sessions = sessions;
		this.keyModified.set("sessions", 1);
